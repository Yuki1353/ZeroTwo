...
@ZeroTwo.on(events.NewMessage(outgoing=True, pattern=r'[!/]mal a? (.+)'))
...
@ZeroTwo.on(events.NewMessage(outgoing=True, pattern=r'[!/]mal m? (.+)'))
...
@ZeroTwo.on(events.NewMessage(outgoing=True, pattern=r'[!/]mal c? (.+)'))
