...
@ZeroTwo.on(events.NewMessage(outgoing=True, pattern=f"^\.my?a?l? a? (.+)$"))
...
@ZeroTwo.on(events.NewMessage(outgoing=True, pattern=f"^\.my?a?l? m? (.+)$"))
...
@ZeroTwo.on(events.NewMessage(outgoing=True, pattern=f"^\.my?a?l? c? (.+)$"))
