...
@ZeroTwo.on(events.NewMessage(outgoing=True, pattern=r'\.my?a?l? a? (.+)'))
...
@ZeroTwo.on(events.NewMessage(outgoing=True, pattern=r'\.my?a?l? m? (.+)'))
...
@ZeroTwo.on(events.NewMessage(outgoing=True, pattern=r'\.my?a?l? c? (.+)'))
